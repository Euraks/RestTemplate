...
class AuthorsIdTest {
    ...
    void setUp() throws SQLException {
        Service<AuthorEntity, UUID> mockedService = Mockito.mock( AuthorEntityService.class );
        Repository<AuthorEntity, UUID> mockedRepository = Mockito.mock( AuthorEntityRepository.class );
